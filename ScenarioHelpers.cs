...
{
    public CommandInfo(SingleModeCookCheckEventResponse.CommonResponse response, int commandId)
    {
        CommandId = commandId;
...
{
    public TrainingPartner(SingleModeCookCheckEventResponse.CommonResponse response, int position, SingleModeCommandInfo command)
    {
...
public sealed class TurnInfoCook
{
    readonly SingleModeCookCheckEventResponse.CommonResponse response;

    public TurnInfoCook(SingleModeCookCheckEventResponse.CommonResponse response)
    {
        this.response = response;
        var cook = response.cook_data_set;
        ...
        CommandInfoArray = cook.command_info_array
            .Select(x => new CommandInfo(response, x.command_id))
    ...
    public SingleModeCookMaterialHarvestInfo[] Harvests { get; }
    public SingleModeCookMaterialInfo[] Materials { get; }
    public SingleModeCookFacilityInfo[] Facilities { get; }
    public SingleModeCookCommandMaterialCareInfo[] CommandMaterials { get; }
    public IReadOnlyList<CommandInfo> CommandInfoArray { get; }
    public SingleModeCookCheckEventResponse.CommonResponse GetCommonResponse() => response;
}
